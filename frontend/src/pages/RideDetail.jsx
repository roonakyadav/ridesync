              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {!isHost && user && !myStatus && isOpen && hasSeats && (
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-900 text-white text-sm font-medium hover:bg-slate-800 active:bg-slate-950 transition shadow-sm disabled:bg-slate-400"
                  >
                ...
                {!isHost && isOpen && waLink && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#25D366] text-white text-sm font-medium hover:bg-[#1ebe57] transition shadow-sm"
                  >
